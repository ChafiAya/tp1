...
# Extracted emails using regex
regex_emails = extracted_data["emails"]


# Count occurrences of each type
count_regex_emails = len(regex_emails)
...
print(f"Emails (total found by regex): {count_regex_emails}")
...
# Compare counts
print("\nComparison results:")
print(f"Emails match (regex vs predefined): {count_regex_emails == predefined_counts['emails']}")
